...
{
    public class MaxCountDefaultMinTests : IArrayLengthTests, IElementExtremeTests
    {
        private readonly ProblemSolution problemSolution;

        public MaxCountDefaultMinTests()
        {
            problemSolution = new ProblemSolution(new MergedFunction(new Max(), new Count(), new DefaultMinConstraint()));
        }
        ...
        [InlineData(new int[] { -511, 7, 1, 1, -511, 1, -588459, 3, 7, 0, 3, 3 })]
        public void DefaultIsMinValueOfCommonOccurrences(int[] A)
        {
